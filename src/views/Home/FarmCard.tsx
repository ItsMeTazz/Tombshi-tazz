import tombshiIcon from '../../assets/img/logo.png';
import toshareIcon from '../../assets/img/wshare.png';
import bondIcon from '../../assets/img/bond.png';
import tombshiToshiIcon from '../../assets/img/tombshiToshiIcon.png';
...
const FarmCard: React.FC<FarmCardProps> = ({ bankName, depositFee, activesOnly, bank, poolStats, account }) => {
  ...
  const depositedInDollars = (
    Number(depositedTokenPriceInDollars) * Number(getDisplayBalance(stakedBalance, bank.depositToken.decimal))
  ).toFixed(2);
  ...
  const getLiquidityLink = () => {
    ...
    } else if (bank.depositTokenName === 'TOMBSHI-USDIBS-LP') {
  ...
  const depositTokenIcon = () => {
    if (bank.depositTokenName === 'TOMBSHI') {
      return tombshiIcon;
    } else if (bank.depositTokenName === 'TOSHARE') {
      return toshareIcon;
    } else if (bank.depositTokenName === 'TOMBSHI-TOSHI-LP') {
      return tombshiToshiIcon;
    } else if (bank.depositTokenName === 'NRWL-YUSD-LP') {
      return nrwlYusd;
    } else if (bank.depositTokenName === 'TOSHBOND') {
      return bondIcon;
    }
  };
  ...
  return (
    <>
      {(activesOnly === false || (activesOnly === true && stakedBalanceNumber > 0)) && (
        <Grid item xs={12}>
                  ...
                  >
                    <div style={{ display: 'flex' }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column' }}>
                        <div>{bankName}</div>
                        <div style={{ fontSize: '12px' }}>{depositFee}% deposit fee</div>
                      </div>
                    </div>
                  </Grid>
                  <Grid
