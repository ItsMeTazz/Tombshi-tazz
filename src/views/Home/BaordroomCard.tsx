...
import wShareUSDC from '../../assets/img/TOSHARE-USDC.E.png';
            ...
            >
              ...
              >
                <Grid container justify="space-between" className="lineItemInner">
                  ...
                  >
                    <img src={rewardTokenIcon()} alt="TOMBSHI-USDC.E" height={38} width={38} className="lineLogo" />
                    {boardroomName}
                  </Grid>
                  <Grid
                    item
                  ...
                  <Grid item xs={4} sm={3} style={{ marginTop: '15px', textAlign: widthUnder600 ? 'center' : 'left' }}>
                    <div className="lineLabel">TOSHARE Staked</div>
                        ...
                        <div className="inputDetailsBox">
                          <div className="inputDetailsBoxInner">
                            ...
                            <div className="balance">
                              {activeDetailsBoxTab === 'Deposit' && <span>Balance: {wshareBalance} TOSHARE</span>}
                              {activeDetailsBoxTab === 'Withdraw' && (
                                <span>
                                  Staked: {stakedBalance} TOSHARE{' '}
                        ...
                        <Box mt={2}>
                          ...
                          >
                            <Grid item className="rewardTokenAmount">
                              {earnings} {boardroomName === 'NRWL BOARDROOM' ? 'NRWL' : 'TOMBSHI'}
                            </Grid>
