...
const NodeCard: React.FC<NodeCardProps> = ({ nodeName, activesOnly, bank, pool, account }) => {
  ...
  const rewardTokenIcon = () => {
    if (nodeName === 'TOMBSHI-USDC.e LP Node') {
      return wlrsUsdcIcon;
    } else if (nodeName === 'TOSHARE-USDC.e LP Node') {
      return wShareUSDCIcon;
    } else if (nodeName === 'NRWL-YUSD LP Node') {
      return nrwlYusdIcon;
    } else if (nodeName === 'GRAPE-TOMBSHI LP Node') {
  ...
  const getLiquidityLink = () => {
    ...
    } else if (bank.depositTokenName === 'GRAPE-TOMBSHI-LP') {
            ...
            >
              ...
              >
                <Grid container justify={'space-between'} alignItems="center" className="lineItemInner">
                  ...
                  >
                    <img src={rewardTokenIcon()} alt="TOMBSHI-USDC.E" height={38} className="lineLogo" />
                    {nodeName}
                  </Grid>
                  <Grid
                    item
                        ...
                        <div className="statBox">
                          <div className="statBoxInner">
                            ...
                            <div className="lineValue">
                              {bank.depositTokenName === 'GRAPE-TOMBSHI-LP' || bank.depositTokenName === 'NRWL-YUSD-LP'
