                ...
                <Grid item xs={12} sm={4} >
                  <HomeCardBlue>
                    ...
                    WALRUS</h2>   
                      ...
                      <Box mt={2}>
                        <TokenSymbol symbol="TOMBSHI" style={{ height: "100%"}} />
                      </Box>
                      <p style={{marginBottom: '0', fontSize: "1.2rem", fontWeight: "600" }}> Stake TOSHARE <br /> Earn TOMBSHI</p>
                    </CardContent>
                ...
                <Grid item xs={12} sm={4}>
                  <HomeCardPurple>
                    ...
                    NARWHAL</h2>
                      ...
                      <p style={{marginBottom: '0', fontSize: "1.2rem", fontWeight: "600" }}>Stake TOSHARE<br /> Earn NRWL</p>
                    </CardContent>
                    <CardActions style={{ justifyContent: 'center' }}>
                      <Button
                        color="primary"
