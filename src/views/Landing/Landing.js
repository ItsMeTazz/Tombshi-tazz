    ...
    <img className="front-model-11" src='https://i.imgur.com/jQQLy3C.png'/>
      ...
      <div className="padding-container">
        <div className="front-container">
          ...
          <span className="front-desc">Tombshi is a seigniorage protocol at it's core built with sustainable yields to last with community support. We are expanding our ecosystem into avenues that allow users utility with our tokens to give them constant value through GameFi and TradeFi mechanics.</span>
          ...
          <Fade bottom>
            <div className="token-box-1">
              ...
              <div className="token-second">
                <span className="token-top-middle">$TOMBSHI</span>
                <span className="token-top-bottom">Walrus token ($TOMBSHI) is designed to be used as a medium of exchange. The built-in stability mechanism in the protocol aims to maintain $TOMBSHI's peg of 1 $TOMBSHI : 1 $USDC.e in the long run. </span>
            ...
            <div className="token-box-2">
              ...
              <div className="token-second">
                <span className="token-top-middle">$TOSHARE</span>
                <span className="token-top-bottom">Walrus Shares ($TOSHARE) are one of the ways to measure the value of the Tombshi Protocol and shareholder trust in its ability to maintain $TOMBSHI close to peg. During epoch expansions, the protocol mints $TOMBSHI and distributes it proportionally to all $TOSHARE holders who have staked their tokens in the Boardroom.</span>
            ...
            <div className="token-box-3">
              ...
              <div className="token-second">
                <span className="token-top-middle">$TOSHBOND</span>
                <span className="token-top-bottom">Bonds are unique tokens that can be utilized to help stabilize TOMBSHI price around peg by reducing the circulating supply of TOMBSHI if the TWAP goes below peg</span>
          ...
          <div className="up-boxes">
            ...
            <a href="https://app.frozenwalrus.finance/boardroom" target="_blank" className="up-box">
              ...
              <div className="up-second">
                ...
                <span className="up-top-bottom">Utilize your share tokens in the boardroom to earn a percentage of the expansion of TOMBSHI tokens when the protocol is healthy!</span>
...
<Fade bottom>
            <a href="https://app.frozenwalrus.finance/farms" target="_blank" className="up-box">
              ...
              <div className="up-second">
                ...
                <span className="up-top-bottom">Deepen liquidity and be rewarded! Adding liquidity to the Tombshi ecosystem is easy and can be used to farm new Share tokens!</span>
                <div className="up-button">
                <img className="up-arrow" src="https://i.imgur.com/jEiRTFm.png"/>
              </div>
              </div>
...
<Fade bottom>
      ...
      <div className="padding-container">
        <div className="news-divide">
          ...
          <Fade right>
         <Accordion
            title="What is Tombshi?"
            content="Tombshi is a DeFi protocol built on Avalanche Network. We offer high yields when providing liquidity to the platform via a reward token. Please read our documentation to get the full picture of the"
            content2="mechanics behind Tombshi as it can be complicated for new users!"
      ...
      <Accordion
            ...
            content="We refer to peg when speaking specifically about the $TOMBSHI token, this is a mechanic the protocol uses to constantly gauge the inflation or deflation of it. We are pegged to USDC.e or $1, this means that when "
            content2="over that amount of $1 the protocol will INFLATE the supply of $TOMBSHI and when under we will attempt to deflate the supply so that we are always inching towards keeping $TOMBSHI at $1 in the market. "
      ...
      <Fade right>
        <Accordion
            title="What chain is Tombshi built on?"
     ...
     <div className="acc-middle"></div>
      <Fade right>
        <Accordion
            ...
            content="It's best to think of it as an elastic supply token, it constantly expands and contracts to try and meet a goal. In this case its taking $TOMBSHI to $1."
          />
          </Fade>
     <div className="acc-middle"></div>
      <Fade right>
        <Accordion
            title="How long will Tombshi be here?"
      ...
      <Fade right>
        <Accordion
            title="Who runs Tombshi?"
            content="The founder of Tombshi Finance is Austin A.K.A Lamehillbilly."
          />
          </Fade>
      <div className="acc-middle"></div>
          ...
          <div className="horizontal-container">
            <div className="footer-container">
              <div className="footer-box-1">
                <div className="navigation-logo">
                  <img className="navigation-image" src=''/>
                  <div className="navigation-logo-text">
                  <span className="footer-logo-text">TOMBSHI</span>
                  </div>
                </div>
                <Fade>
