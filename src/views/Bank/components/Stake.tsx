...
const Stake: React.FC<StakeProps> = ({ bank }) => {
  ...
  const multiplier =
    (bank.depositTokenName.includes('TOMBSHI') || bank.depositTokenName.includes('TOSHARE-USDC-LP')) &&
    !bank.depositTokenName.includes('TOMBSHI-USDIBS-LP') &&
            ...
            {approveStatus !== ApprovalState.APPROVED ? (
              ...
              <>
                <StyledCardActions2>
                  ...
                  <StyledActionSpacer />
                  {
                    // bank.depositTokenName !== 'TOMBSHI-USDC-LP' &&  bank.depositTokenName !== 'TOSHARE-USDC-LP' && bank.depositTokenName !== 'TOMBSHI-USDIBS-LP'
                    bank.depositTokenName !== 'TOMBSHI-USDC-LP' && bank.depositTokenName !== 'TOSHARE-USDC-LP' ? null : (
                      <IconButton
