        ...
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Typography style={{textTransform: 'uppercase', color: '#fff'}}>
              <Value value={bank.depositTokenName === 'GRAPE-TOMBSHI-LP' || bank.depositTokenName === 'NRWL-YUSD-LP' ? getDisplayBalance(nodePrice, bank.depositToken.decimal, 0) : getDisplayBalance(nodePrice, bank.depositToken.decimal, 8)} />
            </Typography>
