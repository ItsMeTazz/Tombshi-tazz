  ...
  return (
    <Grid container spacing={3} style={{ justifyContent: 'center', alignItems: 'center',  }}>
      <Grid item xs={12} sm={6} lg={4}>
        <HomeCardBlue >
          <CardContent>
            <h2 style={{textAlign: 'center', marginBottom: '8%' }}> DEPOSIT TOMBSHI-USDC-LP </h2>
            
              <Grid container style={{ marginTop: '10px',  justifyContent:'center', alignItems: 'center', }}>
                <div  style={{ justifyContent: 'center', alignItems:'center'}}>
                      <TokenSymbol width={72} height={72} symbol={'TOMBSHI-USDC-LP'} /> <br />
                  ...
                  <Grid item xs={12} style={{ marginTop: '10px'}}>
                    ...
                    <h2 style={{ textAlign: 'center' }} > 
                      {(Number(Pegasaurus.userInfo?.amountDeposited) * 10**6).toFixed(2)  + 'µ'} TOMBSHI-USDC-LP
                    </h2>
                  </Grid>
              </Grid>
              ...
              <Grid container style={{ marginTop: '20px', justifyContent:'center'  }}>
                ...
                <h2 style={{ fontSize:'14px', textAlign: 'center', marginTop: '10%'}}>
                  You will receive TOMBSHI-USDC.e LP tokens when you withdraw
                </h2>
              </Grid>
