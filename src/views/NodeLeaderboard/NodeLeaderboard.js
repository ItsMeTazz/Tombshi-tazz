...
<Page>
  ...
  {matches ? (
  <>
    <h2 style={{fontSize: '3rem', textAlign: 'center', marginBottom: '0%',}}>TOMBSHI</h2> <br /> 
    ...
    <Grid  item xs={12} sm={9}>
      <HomeCardBlue>
        ...
        <h2 style={{ fontSize: '1.8vw', textAlign: 'center', marginBottom: '2%'}}>
          Each week, TOSHARE rewards are given to the top creator of TOMBSHI-USDC and TOSHARE-USDC nodes. 
          TOSHARE rewards are also given out randomly amongst all Node creators. 
...
<Grid container spacing={3} direction="row" style={{ display: 'flex', justifyContent: 'center'}} >
    ...
    <Grid  item xs={12} sm={12}>
      <HomeCard>
          ...
          <h2 style={{ fontSize: '1.5vw', textAlign: 'center', marginBottom: '2%'}}>
              These Tombshi champions created at least one (1) TOMBSHI-USDC or TOSHARE-USDC node and 
              were randomly selected to receive one (1) TOSHARE reward! 
          </h2> 
          </CardContent>
          ...
          <Grid container spacing={3} style={{ marginBottom: '5%'}} >
            <Grid spacing={6} direction="column" item xs={6} style={{ display: 'flex', alignItems: 'center' }}> 
              <HomeCardPurple style={{ width: '90%' }} >
                  <h2 style={{ fontSize: '1.5vw', textAlign: 'center'}}><u>TOMBSHI-USDC</u></h2>
            ...
            <Grid spacing={6} direction="column" item xs={6} style={{ display: 'flex', alignItems: 'center' }}> 
              <HomeCardBlue style={{ width: '90%'}}>
                <h2 style={{ fontSize: '1.5vw', textAlign: 'center'}}><u>TOSHARE-USDC</u></h2>
                <h2 style={{ fontSize: '1.5vw', textAlign: 'center'}}>
                      750820c233<br />
                      33734003d8<br />
                      21cbf49580<br />
        ...
        <h2 style={{ fontSize: '1.8vw', textAlign: 'center', marginBottom: '2%'}}>  
          These two Tombshi kings/queens created the most Nodes during this week's timespan and receive five (5) TOSHARE as reward!</h2>
          
          <Grid container spacing={6} style={{ marginBottom: '5%'}} >
            
            <Grid direction="column" item xs={6} style={{ display: 'flex', alignItems: 'center' }}> 
              <HomeCardPurple style={{ width: '90%' }} >
                <h2 style={{ fontSize: '1.8vw', textAlign: 'center', marginTop:'10%'}}><u>TOMBSHI-USDC</u></h2>
            ...
            <Grid spacing={6} direction="column" item xs={6} style={{ display: 'flex', alignItems: 'center' }}> 
              <HomeCardBlue style={{ width: '90%'}}>
                <h2 style={{ fontSize: '1.8vw', textAlign: 'center', marginTop:'10%'}}><u>TOSHARE-USDC</u></h2>
                <h2 style={{ fontSize: '1.5vw', textAlign: 'center', marginBottom: '15%' }}>
                e88EeB6141: 435 
                </h2> 
              </HomeCardBlue>
  ...
  <Grid  item xs={12} sm={12}>
    <HomeCard>
      ...
      <Grid container spacing={3} >   
        <Grid direction="column" item xs={6} style={{ display: 'flex', alignItems: 'center' }}> 
        <HomeCardPurple style={{  width: '90%'}}>
          <h2 style={{ fontSize: '1.8vw', textAlign: 'center'}}><u>TOMBSHI-USDC</u></h2>
        ...
        <Grid spacing={6} direction="column" item xs={6} style={{ display: 'flex', alignItems: 'center' }}> 
        <HomeCardBlue style={{ width: '90%'}}>
        <h2 style={{ fontSize: '1.8vw', textAlign: 'center'}}><u>TOSHARE-USDC</u></h2>
        <h2 style={{ fontSize: '1.5vw', textAlign: 'center', justifyContent: 'space-between' }}>
            e88EeB6141:	435 <br />
            73D80768fD:	198 <br />
            6597f3d3d7:	115 <br />
  ...
  <>
  <h2 style={{fontSize: '36px', textAlign: 'center', marginBottom: '0%',}}>TOMBSHI</h2> <br /> 
      ...
      <HomeCard>
          ...
          <Grid container spacing={3} style={{ marginBottom: '5%'}} >
            <Grid direction="column" item xs={12} style={{ display: 'flex', alignItems: 'center' }}> 
              <HomeCardPurple style={{ width: '90%' }} >
                  <h2 style={{ fontSize: '20px', textAlign: 'center'}}><u>TOMBSHI-USDC</u></h2>
            ...
            <Grid spacing={6} direction="column" item xs={12} style={{ display: 'flex', alignItems: 'center' }}> 
              <HomeCardDBlue style={{ width: '90%'}}>
                <h2 style={{ fontSize: '20px', textAlign: 'center'}}><u>TOSHARE-USDC</u></h2>
                <h2 style={{ fontSize: '20px', textAlign: 'center'}}>
                      750820c233<br />
                      33734003d8<br />
                      21cbf49580<br />
          ...
          <Grid container spacing={6} style={{ marginBottom: '5%'}} >
            ...
            <Grid direction="column" item xs={12} style={{ display: 'flex', alignItems: 'center' }}> 
              <HomeCardPurple style={{ width: '80%' }} >
                <h2 style={{ fontSize: '20px', textAlign: 'center', marginTop:'5%'}}><u>TOMBSHI-USDC</u></h2>
            ...
            <Grid spacing={6} direction="column" item xs={12} style={{ display: 'flex', alignItems: 'center' }}> 
              <HomeCardDBlue style={{ width: '80%'}}>
                <h2 style={{ fontSize: '20px', textAlign: 'center', marginTop:'5%'}}><u>TOSHARE-USDC</u></h2>
                <h2 style={{ fontSize: '20px', textAlign: 'center', marginBottom: '5%' }}>
                e88EeB6141: 435 
                </h2> 
              </HomeCardDBlue>
