  ...
  return (
    <Page>
      ...
      <Grid container spacing={3}>
        <Grid item sm={12} md={6}> {/* grid grid cols-1 */} 
          <Card>
              ...
              <Balances>
                <StyledBalanceWrapper>
                  ...
                  <StyledBalance>
                    ...
                    <Label text="TOMBSHI available" variant="noraml" />
                ...
                <StyledBalanceWrapper>
                  ...
                  <StyledBalance>
                    ...
                    <Label text="TOSHARE available" variant="noraml" />
                    <span style={{ fontSize: '15px', marginLeft: '2%' }}>
                ...
                <StyledBalanceWrapper>
                  ...
                  <StyledBalance>
                    ...
                    <Label text="TOSHBOND available" variant="noraml" />
                    <span style={{ fontSize: '15px', marginLeft: '2%' }}>
        ...
        <Grid item xs={12} sm={4}>
          <Card>
            <CardContent align="center">
              <h2>TOMBSHI-USDC.e LP</h2>
              <div style={{ position: 'absolute', right: 5, top: 5 }}>
                <TokenSymbol width={50} height={50} symbol="TOMBSHI-USDC-LP" />
              </div>
              <Box mt={2}>
        ...
        <Grid item xs={12} sm={4}>
          <Card>
            <CardContent align="center">
              <h2>TOSHARE-USDC.e LP</h2>
              <div style={{ position: 'absolute', right: 5, top: 5 }}>
                <TokenSymbol width={50} height={50} symbol="TOSHARE-USDC-LP" />
              </div>
              <Box mt={2}>
                <span style={{ fontSize: '26px' }}>
        ...
        <Grid item xs={12} sm={3}>
          <Card>
            <CardContent style={{ position: 'relative' }}>
              <div style={{ position: 'absolute', right: 5, top: 5 }}>
                <TokenSymbol symbol="TOSHARE"  height={50} width={50} />
              </div>
              <h2 align="center">TOSHARE</h2>
              <p align="center">Current Price</p>
              <Box align="center">
                <span style={{ fontSize: '30px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        {/* <Grid item xs={12} sm={3}>
          <Card>
            <CardContent style={{ position: 'relative' }}>
              <div style={{ position: 'absolute', right: 5, top: 5 }}>
                <TokenSymbol symbol="TOSHBOND" size={50} />
              </div>
              <h2 align="center">TOSHBOND</h2>
              <p align="center">Current Price</p>
              <Box align="center">
                <span style={{ fontSize: '30px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
