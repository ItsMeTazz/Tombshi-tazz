...
import tombLogo from '../../assets/img/logo.png';
...
import tshareFtmLpLogo from '../../assets/img/TOSHARE-USDC.E.png';
...
const logosBySymbol: { [title: string]: string } = {
  ...
  USDT: usdtLogoPNG,
  USDC: usdcLogoPNG,
  'TOMBSHI-USDC-LP': tombFtmLpLogo,
  'TOSHARE-USDC-LP': tshareFtmLpLogo,
  'TOMBSHI-USDIBS-LP': wlrsUsdibsLP,
  'GRAPE-TOMBSHI-LP': grapeWlrsLP,
